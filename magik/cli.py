...
def main():
    ...
    parser_init = subparsers.add_parser(
        "init", help="Initialize magik testing suite")
    parser_init.set_defaults(func=init)

    # magik generate <test-name>
    parser_generate = subparsers.add_parser(
        "generate", help="Generate a new test")
    ...
    parser_run_production.add_argument(
        "--start_date", help="Start date of the test")
    parser_run_production.add_argument(
        "--end_date", help="End date of the test")
...
def run(args):
    ...
    test_runner.run_tests(args.test_name, args.response)
